...
public class Main {
	...
	public static void main(String[] args) {
		...
		Porco porquinho = new Porco("porquinho", SexoPorcoEnum.MACHO,8, 89);
		...
		Porco porquinhoD = new Porco("porquinhoD", SexoPorcoEnum.FEMEA, 9, 88);
		...
		System.out.println("Porco mais leve macho: "+ chiqueiro.porcoMaisLeveMacho);
		...
		System.out.println("Porco mais leve femea: "+ chiqueiro.porcoMaisLeveFemea);
